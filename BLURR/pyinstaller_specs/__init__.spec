...
a = Analysis(['__init__.py'],
             ...
             datas=[('.\\face_recognition_models\\models\\dlib_face_recognition_resnet_model_v1.dat', './face_recognition_models/models'),
                     ...
                     ('C:\\Users\\patryk.morawski\\Anaconda3\\lib\\site-packages\\eel\\eel.js', 'eel'), ('C:\\Users\\patryk.morawski\\Anaconda3\\lib\\site-packages\\eel\\eel.js', './SettingsWindow/eel') ,('.\\SettingsWindow\\web\\', './SettingsWindow/web/')],
             hiddenimports=['bottle_websocket', 'pystray._win32', 'setuptools.py33compat', 'setuptools.py21compat', 'tendo'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],

...
from Logging.ServerConnection import ServerConnection, UNAUTHORIZED
...
class Blurr():
    ...
    def __init__(self) -> None:
        ...
        self.settingsWindow = SettingsWindow(self.tracker, self.serverConnection, self.setTracking, self.quitBlurr)
    ...
    def startApp(self):
        try:
            ...
            self.isRunning = isAuthorized and Settings.get(Settings.TRACKING_ON)
            self.blocked = False
    ...
    def mainThread(self):
        ...
        while True:
            ...
            if self.blocked:
                self.blockerWindow.show(self.reason, Settings.get(Settings.UNLOCK_PIN))
                self.blocked = False
    ...
    def createTrackingThread(self):
        isTracking = Settings.isSetUp() and Settings.get(Settings.TRACKING_ON, default=False)
        if isTracking:
